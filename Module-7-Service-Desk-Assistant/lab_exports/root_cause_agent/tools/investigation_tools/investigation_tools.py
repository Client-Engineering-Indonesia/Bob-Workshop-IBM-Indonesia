...
def query_recent_deployments(
    ...
    Args:
        incident_time: ISO-8601 timestamp of the incident (e.g. "2025-07-15T14:00:00Z").
                       If empty, uses the current UTC time.
        window_hours:  Hours either side of incident_time to search (default: 2).
        max_results:   Maximum number of runs to return (default: 10, max: 100).
    """
...
def query_commit_changes(
    ...
    Args:
        commit_sha:           Full or short (≥7 char) GitHub commit SHA.
        patch_preview_chars:  How many characters of the raw patch to include per file
